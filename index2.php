...
<div class="container mt-5">
    <form id="filterForm">
        <div class="form-check">
            <input class="form-check-input" type="radio" name="filter" value="alleAbos" id="alleAbos" checked>
            <label class="form-check-label" for="alleAbos">
                Alle Abos anzeigen
            </label>
        </div>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="filter" value="nextMonat" id="nextMonat">
